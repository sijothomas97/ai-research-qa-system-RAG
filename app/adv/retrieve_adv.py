...
def retrieve_relevant_chunks(query, collection_name="arxiv_chunks", top_k=5, hybrid_weight=0.5):
    ...
    '''
    Integrating keyword-based search using rank_bm25 alongside ChromaDB’s vector search.
    '''
    ...
    # Combine scores
    '''
    Using a cross-encoder to re-score retrieved chunks for better relevance (cross-encoder 
    re-score's the top top_k * 2 chunks, improving ranking by directly comparing query-chunk pairs).
    '''
